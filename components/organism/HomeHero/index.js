            ...
            <div className="dc-container">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    ...
                    <Link 
                        href='/about'
                    >
                    <div className="bg-[#F9F9F9] hover:bg-[#FF5733] dark:bg-[#2C2C2C] dark:hover:bg-[#68CC93] card1 animation-effect flex items-center group">
                        <div className="flex flex-col relative w-full">
                        <h1 className="md:group-hover:text-transparent font-[700] text-[#1C1C1C] group-hover:text-[#E4E4E4] dark:text-[#E4E4E4]  text-[40px] tracking-[-2px] md:group-hover:-translate-y-6 animation-effect">Hey, I'm Dante</h1>
                        <div className="justify-between flex items-center md:group-hover:translate-y-6 animation-effect">
                            <h1 className="hidden md:block mr-5 md:group-hover:text-transparent font-[500] text-[#7E7E7E] text-[20px] tracking-[-1px] animation-effect">"Website without visitors is like a ship lost in the horizon."</h1>
                    ...
                    >
                    <div className="bg-[#F9F9F9] hover:bg-[#FF5733] dark:bg-[#2C2C2C] dark:hover:bg-[#68CC93] card1 animation-effect group flex overflow-hidden">
                        <div className="flex flex-col relative w-full">
                        <div className="justify-between flex items-center group-hover:translate-y-6 animation-effect">
                            <div className="flex flex-col">
                            <h1 className="mr-5 group-hover:text-transparent font-[500] text-[#1C1C1C] dark:text-[#E4E4E4] text-[14px] tracking-[-1px] animation-effect">Corporate Website</h1>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    <Link href='/works'>
                        <div className="bg-[#F9F9F9] hover:bg-[#FF5733] dark:bg-[#2C2C2C] dark:hover:bg-[#68CC93] card1 group flex overflow-hidden animation-effect">
                        <div className="flex flex-col justify-center relative w-full">
                            <BsStack className="text-[#7E7E7E] mt-10 group-hover:hidden w-[75px] h-[75px] mx-auto lg:mx-0"/>
                            <div className="justify-between flex items-center ">
                            <h1 className="mx-auto lg:mx-0 font-[500] text-[#1C1C1C] dark:text-[#E4E4E4] text-[28px] tracking-[-1px] group-hover:text-transparent animation-effect">See My Work</h1>
                    ...
                    <div className="bg-[#F9F9F9] hover:bg-[#FF5733] dark:bg-[#2C2C2C] dark:hover:bg-[#68CC93] card1 group flex overflow-hidden animation-effect">
                        <div className="flex flex-col relative w-full">
                        <h1 className="mr-5 font-[500] text-[#1C1C1C] dark:text-[#E4E4E4] group-hover:text-[#E4E4E4] text-[14px] tracking-[-1px]">WHAT I USE</h1>
                        <div className="">
                            <div className='logos'>
