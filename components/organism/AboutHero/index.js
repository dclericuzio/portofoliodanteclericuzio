        ...
        <div className="bg-[#1C1C1C] min-h-screen pt-20 pb-5 px-[16px]">
            <div className="dc-container">
                ...
                <div className="grid grid-cols-4 gap-5">
                    ...
                    <div className="group sm:h-[300px] h-fit col-span-4 sm:col-span-2 lg:col-span-1 flex card1 animation-effect">
                        <div className="flex flex-col relative w-full">
                            <h1 className="font-[700] text-[#E4E4E4] text-[28px] tracking-[-2px]">Hey, I'm Dante</h1>
                    ...
                    <div className="group col-span-4 lg:col-span-2 flex card1 animation-effect">
                        <div className="flex flex-col">
                            <FaGraduationCap className='text-[100px] text-[#E4E4E4]'/>
                            <h1 className="font-[500] text-[#E4E4E4] text-[28px] tracking-[-1px]">Bachelor Of Engineering</h1>
                    ...
                    <div className="group col-span-4 flex p-[32px] h-fit card1 animation-effect">
                        <div className="flex flex-col">
                            <h1 className="mb-5 font-[500] text-[#E4E4E4] text-[28px] tracking-[-2px]">Background</h1>
                            ...
                            <div className='mt-5 flex flex-wrap gap-5'>
                                {skills.map((item, i)=>(
                                    <div key={i} className='flex gap-1 items-center'>
                                        <VscDebugBreakpointFunctionUnverified className='rotate-90 group-hover:text-[#E4E4E4] text-[#68CC93]'/>
